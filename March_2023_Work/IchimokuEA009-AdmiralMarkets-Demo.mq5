//+------------------------------------------------------------------+
//|                            IchimokuEA009-AdmiralMarkets-Demo.mq5 |
...
double totalProfit = 0, previousTotalProfit = 0;
int nbWon = 0, nbLost = 0;
...
//printf("ontick");
   ...
   if(totalProfit != previousTotalProfit)
     {
      printf("######## Change for totalProfit=" + string(totalProfit) + " ######## nbWon=" + string(nbWon) +" ######## nbLost=" + string(nbLost));
     }
...
input double lots = 0.01; // number of lots for each trade
