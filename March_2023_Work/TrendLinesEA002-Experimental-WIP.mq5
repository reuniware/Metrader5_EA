//+------------------------------------------------------------------+
//|                             TrendLinesEA002-Experimental-WIP.mq5 |
...
double minPrice1=0, minPrice2=0;
datetime dtMaxPrice1, dtMaxPrice2;
datetime dtMinPrice1, dtMinPrice2;
int barsForTrendline = 64;
string arrayDateTimesAndHighs[64];
string arrayDateTimesAndLows[64];
...
//msg += "r\nUP/DOWN (Numeric keypad) to change the number of bars.";
   ...
   dtMinPrice1 = NULL;
   dtMinPrice2 = NULL;
   ArrayFree(arrayDateTimesAndLows);
...
void processPoint1()
  {
   ...
   printf("Array at the end of processPoint1");
