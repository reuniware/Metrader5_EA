...
string url="http://192.168.1.251:9090/send_data/";
   ...
   for(sindex=0; sindex<stotal; sindex++)
     {
      ...
      if(SymbolInfoTick(sname,last_tick))
        {
         // Time, Tick count, Symbol, Bid, Ask, Vol
         SendData(last_tick.time+";" + GetTickCount() + ";"+sname+";"+last_tick.bid+";"+last_tick.ask+";"+last_tick.volume);
        }
