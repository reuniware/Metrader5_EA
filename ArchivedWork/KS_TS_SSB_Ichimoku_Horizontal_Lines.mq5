//+------------------------------------------------------------------+
//|                          KS_TS_SSB_Ichimoku_Horizontal_Lines.mq5 |
...
//+------------------------------------------------------------------+
input int minNumberOfSameConsecutiveValuesNeeded_KS=6;
input int minNumberOfSameConsecutiveValuesNeeded_TS=6;
input int minNumberOfSameConsecutiveValuesNeeded_SSB=6;
//+------------------------------------------------------------------+
//|                                                                  |
//+------------------------------------------------------------------+
color ExtClr[140]=
